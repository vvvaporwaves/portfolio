...
const Home = () => {
  return (
    <div className="container p-6 lg:p-0 max-w-[1000px] m-auto text-center flex content-center">
      <div className="grid w-full aspect-square place-self-center">
        ...
        <h1 className="body col-start-1 col-end-2 z-5 relative row-start-1 row-end-2 place-self-center w-[49%] break-all p-[1rem_1rem_0rem] md:p-[2rem_1rem_0rem] heading">
          vaporwaves
        </h1>
      </div>
    </div>
